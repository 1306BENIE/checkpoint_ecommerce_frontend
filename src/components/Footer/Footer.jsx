    ...
    <footer className="bg-gray-800 text-white py-8 mt-3">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p>
              Email :{" "}
              <a
                href="mailto:sylvestrebenie7829@gmail.com"
          ...
          <div>
            ...
            <form className="flex">
              ...
              <button
                type="submit"
                className="bg-blue-600 hover:bg-blue-500 text-white px-6 py-2 rounded-r-md"
              >
                S'abonner
              </button>
            </form>
        ...
        <div className="mt-12 text-center text-gray-400">
          <p>&copy; 2025 Anidassor Shop. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  );
